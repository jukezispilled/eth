...
function App() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('8UPBT7vw9PWoA3AVKSDb38ETr2F4yXVpjLx82nXYnmdA');
    setCopied(true);
    setTimeout(() => {
      setCopied(false);
    ...
    >
      <div className='absolute left-5 top-5 flex justify-center rounded-full'>
        <div className='rounded-full flex justify-center bg-slate-100 z-10 items-center gap-1 md:gap-4 px-5 py-3 max-w-full border-2 border-sky-500'>
          ...
          8UPBT7vw9PWoA3AVKSDb38ETr2F4yXVpjLx82nXYnmdA
          </div>
        </div>
      </div>
      ...
      <div className="absolute md:top-5 bottom-5 right-5 flex flex-col items-center z-10">
        <div className="flex flex-row">
          <a href="https://x.com/solanaethcoin" className="p-2 hover:scale-110 transition ease-in-out duration-200">
